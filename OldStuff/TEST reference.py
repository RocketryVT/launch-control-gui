# -*- coding: utf-8 -*-
"""
Created on Tue Mar  5 12:47:49 2019
...
packets = transmission.fromFile("C:\\Users\\Alejandro\\Documents\\School\\VTech Rocketry\\GUI code\\parsing-test.bin")
line = 0
...
def copy(arg=None):
    ...
    global line       
    packet = packets[line]
    s=transmission.packet2str(packet)
    print(s)
    output["text"] += s + '\n'
    line = line + 1
